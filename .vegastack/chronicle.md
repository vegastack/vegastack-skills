...
- **How it went:** Straightforward. The sweep found a seventh case the brief had not named (a second archived plan with the same merged header) — folded in rather than left to make the acceptance claim false. Everything else went in at its one home, so nothing has to be remembered next time.
