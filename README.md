...
| [dev-debug](skills/dev-debug/) | Reproduce-first bug work: a red-capable repro command before any theory, shrink-to-load-bearing, ranked falsifiable suspects posted without pausing, tagged instrumentation, regression-test-before-fix at a correct seam, and cleanup ship-gate can verify | [Walkthrough](skills/dev-debug/README.md) · [SKILL.md](skills/dev-debug/SKILL.md) |
