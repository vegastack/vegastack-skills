...
Skill scanning is not this skill's: the [skill-scan](../../skills-tooling/skill-scan/README.md) skill owns the scanner, its knobs and its suppression baseline, and the security axis consumes the report it produces.
