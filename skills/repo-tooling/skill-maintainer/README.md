...
| [references/standards.md](references/standards.md) | The complete tri-harness standards: per-harness discovery paths, frontmatter rules, context budgets, install surfaces, the seven portability rules, the skill-scan suppression discipline, and the UNVERIFIED register |
