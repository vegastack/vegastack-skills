...
| [references/release-ops.md](references/release-ops.md) | Condensed release / rename / rollback playbook, derived from and subordinate to [docs/policies](../../docs/policies/) |
